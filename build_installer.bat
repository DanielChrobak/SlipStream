...
if "%USE_NSIS%"=="1" (echo NSIS found - will create installer) else (echo NSIS not found - will create ZIP package)
echo.
...
if errorlevel 1 (cd .. & echo [ERROR] Packaging failed & pause & exit /b 1)
