...
- **System Tray Control** - Starts minimized to tray; right-click tray menu for Open/Exit
- **Multi-Network URL Output** - Startup logs all non-loopback LAN IPv4 URLs
...
Creates `build\SlipStream-1.0.0-Setup.exe` (Inno Setup).
